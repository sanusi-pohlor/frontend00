...
const MapWidget = () => {
  ...
  const handleMouseEnter = async (event) => {
    ...
    try {
      const response = await fetch(`https://fakenews001-392577897f69.herokuapp.com/api/region/${regionId}`);
      if (response.ok) {
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Tooltip
            title="Nakhon Si Thammarat" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
              id="nrt"
          ...
          <Tooltip
            title="Krabi" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Phangnga" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Phuket" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Surat Thani" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Ranong" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Chumphon" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Songkhla" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Satun" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Trang" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Phatthalung" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Pattani" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Yala" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
          ...
          <Tooltip
            title="Narathiwat" // Replace with the name of the region
            arrow
            placement="top" // You can adjust the tooltip placement (top, bottom, left, right)
          >
            <path
