...
const About_Us_View = () => {
  const createTypography = (label, text, fontSize = "25px") => (
    <Typography
      style={{ textIndent: "20px", marginTop: "20px" }}
      variant="body1"
      sx={{ fontSize }}
    >
      {label} {text}
